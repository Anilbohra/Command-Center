...
<body>
    <div id="app">
        ...
        <main class="py-4">
            <form action="/input-db" method="post">
                @csrf
                <label for="npp">Nomor Pokok Pegawai</label>
                <input type="text" name="npp" id="npp">
                <label for="mesin">Nama Lengkap</label>
                <input type="text" name="nama" id="nama">
                <label for="mesin">Nomor Kartu</label>
                <input type="text" name="kartu" id="kartu">
                <label for="mesin">Divisi</label>
                <input type="text" name="divisi" id="divisi">
                <button type="submit">Tambah Pegawai ke Database</button>
            </form>
        </main>
    </div>
    @yield('footer-script')
